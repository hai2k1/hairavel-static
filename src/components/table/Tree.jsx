...
export default defineComponent({
    ...
    methods: {
        ...
        // Get the expanded state save name
        ...
        handleDrop({ dragNode, dropNode, dropPosition }) {
            ...
            // The returned data does not conform to the mapping, recombine
            const newData = {
    ...
    render() {
        ...
        return <div class="flex flex-col h-full">
            ...
            >
                <a-spin class="block flex flex-col h-full" loading={this.loading} tip="Loading node...">
                    <a-tree
                        class="app-tree"
                        data={this.data}
                        showLine={true}
