            ...
            >
                {{
                    item: (item) => <div
                        ...
                        style={{
                            backgroundSize: '90%',
                            backgroundImage: `url(${item.element || '/service/image/placeholder/180/180/选择图片'})`
                        }}
                    >
                        <div
                            class="flex p-2 gap-2 bg-white bg-opacity-80  dark:bg-blackgray-5 dark:bg-opacity-80 w-28 h-28 opacity-0 hover:opacity-100 items-center">
                    ...
                    footer: () => this.type !== 'manage'
                        ...
                        : <div class="relative w-28 h-28 rounded block" onClick={this.fileManage}>
                            <div
                                class="text-gray-600 hover:text-blue-600 absolute flex items-center justify-center w-full h-full bg-gray-100  hover:bg-gray-200 dark:bg-blackgray-1 dark:hover:bg-blackgray-2 rounded cursor-pointer">
                                <div class="flex items-center flex-col justify-center ">
                                    <icon-upload class="text-2xl"/>
