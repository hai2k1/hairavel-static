    ...
    created() {
        ...
        this.option && columns.push({
            title: <div class="flex">
                <div class="flex-grow">Operate</div>
    ...
    methods: {
        ...
        setData(data, init) {
            ...
            if (!init && this.number && this.number < number) {
                window.message.warning('up to ' + this.number + ' Article data')
                return false;
            }
    ...
    render() {
        return <div class="w-full">
            <div class="overflow-x-auto w-full mb-2">
                <a-table stripe={true} loading={this.loading} columns={this.columns} data={this.data} pagination={false}
