                                ...
                                <template v-else>
                                    ...
                                    <div>
                                        <a-button
                                            ...
                                            long
                                        >
                                            {{ data.register ? "register log in" : "Log in" }}
                                        </a-button>
                                        <div
                                            v-if="data.register"
                                            class="text-center text-gray-600 mt-2"
                                        >
                                            The first login will use the account password to register
                                        </div>
                                    </div>
                                </template>
                            </form>
    ...
    setup() {
        ...
        return {
            ...
            config: {
                ...
                title: window.appConfig.login.title || "Haibase",
                name: window.appConfig.login.name || "Haibase",
